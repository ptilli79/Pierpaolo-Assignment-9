...
public class Recipe {
	...
	public Recipe (Integer recipeNumber,Integer cookingMinutes, Boolean dairyFree, Boolean glutenFree, String instructions, Double preparationMinutes, Double pricePerServing, Integer readyInMinutes, Integer servings, Double spoonacularScore, String title, Boolean vegan, Boolean vegetarian) {
	...
	public String toString() {
		return "['recipeNumber': " + recipeNumber +", 'cookingMinutes': " + cookingMinutes + ", 'dairyFree': " + dairyFree + ", 'glutenFree': " + glutenFree
